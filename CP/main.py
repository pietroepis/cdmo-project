...
filename = "ins-" + (str(sys.argv[1]) if len(sys.argv) == 2 else "30") + ".txt"
...
dimensions = list(zip(instance["w"], instance["h"])) if not allow_rotation else result["actual_dimensions"]
